...
export default function Home() {
  ...
  return (
      ...
      <div className='bg-[#A5925A] grid grid-cols-3 w-681 items-center px-10'>
              <div className='p-4 text-lg lg:text-4xl w-max text-[#232323] font-bold flex items-center'>
              {/* Website Logo */}
              <img src="/logo.png" alt="Website Logo" className="w-8 h-8 mr-3" /> {/* Adjust size as needed */}
              <div>
